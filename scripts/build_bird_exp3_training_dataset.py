...
TRAIN_FILE = Path(
    "data/external/bird/train.json"
)

TABLES_FILE = Path(
    "data/external/bird/train_tables.json"
)
...
TRAIN_OUTPUT = (
    OUTPUT_DIR
    / "bird_exp3_train.jsonl"
)

VALIDATION_OUTPUT = (
    OUTPUT_DIR
    / "bird_exp3_validation.jsonl"
)
...
def main():
    ...
    print(
        ...
        "plan-supervised training records..."
    )
    ...
    print("=" * 60)
    print(
        "BIRD EXPERIMENT 3 TRAINING DATASET"
    )
    print("=" * 60)
